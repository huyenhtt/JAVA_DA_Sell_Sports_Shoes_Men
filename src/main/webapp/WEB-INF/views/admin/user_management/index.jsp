...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
        <c:forEach varStatus="i" var="nd" items="${lstNd.getContent()}">
            <tr>
                ...
                <td>
                    ...
                    <a href="/admin/user/update/${nd.taiKhoan.id}" class="btn btn-warning"><i
                            class="bi bi-pencil-square"></i></a>
                    <a href="/admin/user/delete/${nd.taiKhoan.id}}" class="btn btn-danger"><i class="bi bi-trash3-fill"></i></a>
                </td>
            </tr>
